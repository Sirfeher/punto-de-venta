 ...
 * @author ANDRES
 */
public class Interfaz_principal_1 extends javax.swing.JFrame {
    ...
    public Interfaz_principal_1() {
        initComponents();
    }
    
    public Interfaz_principal_1(usuarios mod) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jMenuItem12.setText("Ingresar gasto");
    ...
    private void jMenuItem12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem12ActionPerformed
        interfaz_gasto gastos = new interfaz_gasto();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Interfaz_principal_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Interfaz_principal_1().setVisible(true);
            }
        });
    }
